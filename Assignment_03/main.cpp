// Date: 03/05/2022
// Description: Chapter 3 - Assignment
// Developed by Group 3: Alavi Isa, Eduardo Garcia, Jose Caceres, Matthew Batres, Victor Huerta
...
{
    cout << "\n\t==============================================================================================";
    cout << "\n\tCMPR131 Chapter 3 - Games Applications using Container by Group 3 - Alavi Isa, Eduardo Garcia";
    cout << "\n\t==============================================================================================";
    cout << "\n\t\t1> Tic-Tac-Toe";
    cout << "\n\t\t2> Tower of Hanoi";
    cout << "\n\t\t3> n-Queens";
